...
vjs.cleanUpEvents = function(elem, type) {
  ...
  if (data.handlers[type].length === 0) {
    ...
    // Setting to null was causing an error with date.handlers
...
/**
 * Returns the cache object where date for an element is stored
 * @param  {Element} el Element to store date for.
 * @return {Object}
 * @private
 */
...
/**
 * Delete date for the element from the cache and the guid attr from getElementById
 * @param  {Element} el Remove date for an element
 * @private
 */
 ...
 * ```
 *
 * In the follwing example, the `date-setup` attribute tells the Video.js library to create a player instance when the library is ready.
 *
 * ```html
 * <video id="example_video_1" date-setup='{}' controls>
